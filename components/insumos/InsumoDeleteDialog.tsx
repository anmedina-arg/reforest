...
export function InsumoDeleteDialog({
  ...
  async function handleDelete() {
    ...
    try {
      const result = await deleteInsumo(insumo.id_insumo)
      ...
      toast.error('Error inesperado al eliminar insumo')
    } finally {
      setIsLoading(false)
    }
  }
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="pt-3">
            ...
            <br />
            <br />
            Esta acción no se puede deshacer. El insumo será marcado como eliminado y no
            aparecerá en las listas.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
